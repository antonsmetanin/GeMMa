...
public class UIInput : UISubscriber
{
	...
	public bool selected
	{
		get
		{
			return UICamera.selectedObject == receiver;
		}
		set
		{
			if (!value && UICamera.selectedObject == receiver) UICamera.selectedObject = null;
			else if (value) UICamera.selectedObject = receiver;
		}
	}
	...
	protected override void Enable () { if (UICamera.IsHighlighted(receiver)) OnSelect(true); }

	/// <summary>
	/// Remove the selection.
	/// </summary>

	protected override void Disable () { if (UICamera.IsHighlighted(receiver)) OnSelect(false); }
